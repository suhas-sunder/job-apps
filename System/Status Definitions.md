...
Use these canonical statuses for application notes and dashboard counts.

| Status | Meaning |
|---|---|
| Considering | Job identified but application not yet confirmed as submitted |
| Applied | Application submission is confirmed |
| Recruiter Screen | Recruiter or initial screening conversation requested, scheduled, or underway |
| Interview | Formal interview stage is active |
| Assessment | Employer-requested test, technical exercise, take-home, questionnaire, or similar evaluation is active |
| Final Stage | Employer has explicitly indicated a final interview, final review, references, background checks, or another clearly final-stage step |
...
- Prefer the furthest confirmed active stage.
